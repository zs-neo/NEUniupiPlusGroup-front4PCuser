      ...
      <div class="container">
        <div class="cart-box">
          <ul class="cart-item-head">
            <li class="col-3">通知内容</li>
            <li class="col-1">时间</li>
            <li class="col-1">操作</li>
          </ul>
          <ul class="cart-item-list">
            <li class="cart-item">
              <div class="item-name">您的优惠券【五元满减】即将过期！</div>
              <div class="item-total">2020/7/4 22:22:22</div>
              <div class="item-del" @click="delProduct(item)"></div>
            </li>
            <li class="cart-item">
              <div class="item-name">您的优惠券【五百万满减】即将过期！</div>
              <div class="item-total">2020/7/4 22:22:22</div>
              <div class="item-del" @click="delProduct(item)"></div>
            </li>
            <li class="cart-item">
              <div class="item-name">您的优惠券【一个亿满减】即将过期！</div>
              <div class="item-total">2020/7/4 22:22:22</div>
              <div class="item-del" @click="delProduct(item)"></div>
            </li>
          </ul>
